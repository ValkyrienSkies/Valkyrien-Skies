...
public interface IWorldVW {
    /**
     * Makes a physics wrapper entity be ignored by the {@link net.minecraft.world.World#rayTraceBlocks(Vec3d, Vec3d, boolean, boolean, boolean)} method (and
     * overloads thereof).
     * <p>
     * This has no effect on the behavior of {@link #rayTraceBlocksIgnoreShip(Vec3d, Vec3d, boolean, boolean, boolean, PhysicsWrapperEntity)}.
     * <p>
     * Must be followed later by a call to {@link #unexcludeShipFromRayTracer(PhysicsWrapperEntity)} with the same {@link PhysicsWrapperEntity} instance as a
     * parameter.
     *
