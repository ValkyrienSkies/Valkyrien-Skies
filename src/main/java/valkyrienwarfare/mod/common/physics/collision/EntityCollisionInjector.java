...
import valkyrienwarfare.mod.common.physics.collision.polygons.EntityPolygonCollider;
import valkyrienwarfare.mod.common.physics.collision.polygons.Polygon;
import valkyrienwarfare.mod.common.physics.collision.polygons.ShipPolygon;
        ...
        for (PhysicsWrapperEntity wrapper : ships) {
            if (!entity.isRidingSameEntity(wrapper)) {
                ...
                if (wrapper.getPhysicsObject().ownsChunk(entityChunkX, entityChunkZ)) {
                    Chunk chunkIn = wrapper.getPhysicsObject()
