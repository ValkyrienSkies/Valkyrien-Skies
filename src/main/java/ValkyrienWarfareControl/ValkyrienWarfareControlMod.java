...
public class ValkyrienWarfareControlMod {
	...
	private void registerBlocks(FMLStateEvent event) {
		...
		ValkyrienWarfareMod.registerBlock(advancedEtherCompressor);
		ValkyrienWarfareMod.registerBlock(eliteEtherCompressor);
		ValkyrienWarfareMod.registerBlock(ultimateEtherCompressor);
		ValkyrienWarfareMod.registerBlock(creativeEtherCompressor);
