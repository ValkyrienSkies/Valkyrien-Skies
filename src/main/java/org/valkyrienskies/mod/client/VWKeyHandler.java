...
public class VWKeyHandler {
    ...
    public static final KeyBinding airshipRight = new KeyBinding("Airship Turn Right",
        Keyboard.KEY_D, VW_KEYBIND_IDENTIFIER);
