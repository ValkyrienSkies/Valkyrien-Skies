...
public class PhysicsParticleManager {
    ...
    public void spawnPhysicsParticle(float posX, float posY, float posZ, float velX, float velY,
        float velZ, float mass, float timeToLive) {
        physicsParticles
            .add(new PhysicsParticle(posX, posY, posZ, velX, velY, velZ, mass, timeToLive));
    }
    ...
    private static class PhysicsParticle {
        ...
        PhysicsParticle(float posX, float posY, float posZ, float velX, float velY, float velZ,
            float mass, float particleLife) {
            this.posX = posX;
            this.posY = posY;
            this.posZ = posZ;
            this.velX = velX;
