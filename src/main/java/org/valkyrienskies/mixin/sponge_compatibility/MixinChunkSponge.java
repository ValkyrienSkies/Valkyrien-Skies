...
@Implements(@Interface(iface = IMixinChunk.class, prefix = "valkyrienskies$"))
public abstract class MixinChunkSponge implements IMixinChunk {

    @Shadow @Final
    public World world;

    @Intrinsic(displace = true)
    public IBlockState valkyrienskies$setBlockState(BlockPos pos, IBlockState newState, IBlockState currentState, BlockChangeFlag flag) {
        if (!world.isRemote) {
        ...
        return setBlockState(pos, newState, currentState, flag);
    }
}
