...
public class Polygon{
	...
	public void setAABBCorners(AxisAlignedBB bb){
		vertices[0].X = bb.minX; vertices[0].Y = bb.minY; vertices[0].Z = bb.minZ;
		vertices[1].X = bb.minX; vertices[1].Y = bb.maxY; vertices[1].Z = bb.minZ;
		vertices[2].X = bb.minX; vertices[2].Y = bb.minY; vertices[2].Z = bb.maxZ;
		vertices[3].X = bb.minX; vertices[3].Y = bb.maxY; vertices[3].Z = bb.maxZ;
		vertices[4].X = bb.maxX; vertices[4].Y = bb.minY; vertices[4].Z = bb.minZ;
		vertices[5].X = bb.maxX; vertices[5].Y = bb.maxY; vertices[5].Z = bb.minZ;
		vertices[6].X = bb.maxX; vertices[6].Y = bb.minY; vertices[6].Z = bb.maxZ;
		vertices[7].X = bb.maxX; vertices[7].Y = bb.maxY; vertices[7].Z = bb.maxZ;
	}

	public void offsetCorners(AxisAlignedBB bb,double x,double y,double z){
		vertices[0].X = bb.minX+x; vertices[0].Y = bb.minY+y; vertices[0].Z = bb.minZ+z;
		vertices[1].X = bb.minX+x; vertices[1].Y = bb.maxY+y; vertices[1].Z = bb.minZ+z;
		vertices[2].X = bb.minX+x; vertices[2].Y = bb.minY+y; vertices[2].Z = bb.maxZ+z;
		vertices[3].X = bb.minX+x; vertices[3].Y = bb.maxY+y; vertices[3].Z = bb.maxZ+z;
		vertices[4].X = bb.maxX+x; vertices[4].Y = bb.minY+y; vertices[4].Z = bb.minZ+z;
		vertices[5].X = bb.maxX+x; vertices[5].Y = bb.maxY+y; vertices[5].Z = bb.minZ+z;
		vertices[6].X = bb.maxX+x; vertices[6].Y = bb.minY+y; vertices[6].Z = bb.maxZ+z;
		vertices[7].X = bb.maxX+x; vertices[7].Y = bb.maxY+y; vertices[7].Z = bb.maxZ+z;
	}
	...
	public static Vector[] getCornersForAABB(AxisAlignedBB bb){
		return new Vector[]{
			new Vector(bb.minX, bb.minY, bb.minZ),
			new Vector(bb.minX, bb.maxY, bb.minZ),
			new Vector(bb.minX, bb.minY, bb.maxZ),
			new Vector(bb.minX, bb.maxY, bb.maxZ),
			new Vector(bb.maxX, bb.minY, bb.minZ),
			new Vector(bb.maxX, bb.maxY, bb.minZ),
			new Vector(bb.maxX, bb.minY, bb.maxZ),
			new Vector(bb.maxX, bb.maxY, bb.maxZ)
		};
	}
