...
public enum InfuserButton {
    ...
    ASSEMBLE_SHIP("gui.assemble_ship", "gui.disassemble_ship", (tileEntity) -> !tileEntity.isCurrentlyInShip(), (tileEntity) -> tileEntity.canMaintainShip() && tileEntity.canShipBeDeconstructed()),
    ENABLE_PHYSICS("gui.enable_physics", "gui.disable_physics", (tileEntity) -> !tileEntity.isPhysicsEnabled(), (tileEntity -> tileEntity.canMaintainShip() && tileEntity.isCurrentlyInShip())),
    ALIGN_SHIP("gui.align_ship", "gui.stop_align_ship", (tileEntity) -> !tileEntity.isTryingToAlignShip(), tileEntity -> tileEntity.canMaintainShip() && tileEntity.isCurrentlyInShip());
