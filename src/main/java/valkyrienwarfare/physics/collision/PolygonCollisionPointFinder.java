...
//		System.out.println(contactPoint);
		...
		Vector contactPoint = collider.collisions[minCollisionIndex].movable.getVertices()[minCollisionIndexIndex];//contactPoint.getAddition(axis.getProduct(reverseVelocityAlongAxis * secondsAgo));
