...
public abstract class NodeChildrenTransformer<T> implements NodeTransformer<T> {
     ...
     * </ul>
     *
     * @param nodes    multimap of functions to transformer nodes. Each function is used to retrieve a collection of nodes from this node, which are transformed through node transformers.<br>
     ...
     * @param modified function accepting triple of parent node, old child node and new child node, and returning new parent node (or old one if modifications do not require re-instantiation).<br>
    ...
    public static class Builder<T> {
         ...
         *
         * @param parent2children function returning children nodes
         * @param transformer     children node transformer. Children type safety is guaranteed.
         * @param modified        function applying transformer modifications<br>
         * @return <tt>this</tt>
         */
